...
params.sample_dir = params.sample_name + "_" + params.tissue
...
workflow {
    ...
    upload_files(params.sample_dir, params.sample_name, params.proband, params.tissue, params.output_bucket, rrna_samtools_flagstat_ch, globinrna_samtools_flagstat_ch, star_alignreads_ch, feature_counts_ch, outrider_table_ch, rnaseqc_ch, cram_ch, irfinder_ch, fastp_ch)
}
